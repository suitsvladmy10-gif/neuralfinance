...
export function RolloverModal({ isOpen, onClose, surplus, onRollover, onSaveToSavings, onSplit }: RolloverModalProps) {
        ...
        >
          ...
          >
            ...
            <div className="text-center mb-6 relative z-10">
              ...
              <h2 className="text-xl font-bold mb-2 text-white">День подошел к концу</h2>
            ...
            <div className="space-y-3 relative z-10">
              <button
                ...
                className="w-full flex items-center justify-between p-4 rounded-xl bg-[#2E323E]/30 border border-[#2E323E] hover:border-primary/50 transition-colors group"
              >
                <div className="flex items-center gap-3">
                  <ArrowRight className="w-5 h-5 text-gray-400 group-hover:text-primary transition-colors" />
                  <span className="font-medium text-sm text-white">Перенести на завтра</span>
                </div>
              </button>

              <button
                onClick={handleSavings}
                className="w-full flex items-center justify-between p-4 rounded-xl bg-primary/10 border border-primary/30 hover:border-primary transition-colors group"
              >
                <div className="flex items-center gap-3">
              ...
              <button
                onClick={handleSplit}
                className="w-full flex items-center justify-between p-4 rounded-xl bg-[#2E323E]/30 border border-[#2E323E] hover:border-white/30 transition-colors group"
              >
                <div className="flex items-center gap-3">
                  <SplitSquareHorizontal className="w-5 h-5 text-gray-400 group-hover:text-white transition-colors" />
                  <span className="font-medium text-sm text-white">Поделить 50/50</span>
                </div>
              </button>
            </div>
          </motion.div>
